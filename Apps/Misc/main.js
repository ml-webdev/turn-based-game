...
export const checkDamage = (attacker, move, defender) => {
    ...
    if (damage > 0) {
        ...
        document.getElementById('pokemon-message-left').innerText = attacker.name + " attack missed!"
        document.getElementById('pokemon-message-right').innerText = attacker.name + " attack missed!"
...
export const checkAccuracy = (move) => {
    ...
    document.getElementById('pokemon-message-left').innerText = `${attacker.name} + " used " + ${move[0]} + "!"`
    document.getElementById('pokemon-message-right').innerText = `${attacker.name} + " used " + ${move[0]} + "!"`
